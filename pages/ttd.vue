    ...
    async saveScript(device_id, script,option = null) {
      ...
      if (option){
        ...
        if (option?.yummyTrack) {
          const scriptTrack = btoa(unescape(encodeURIComponent(`_G.Config = { UserID = "08432d86-5203-427d-bab2-298b2ab63da7", discord_id = "663236418499379240" , Note = "VPS_${this.map_device_id_code[device_id]}", } loadstring(game:HttpGet("${option.yummyTrack}"))()`)))
